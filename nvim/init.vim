...
set tabstop=2 softtabstop=2     " tab寬度
set updatetime=400
set noswapfile
...
" handlebars
autocmd BufRead,BufNewFile *.hbs setlocal tabstop=2 shiftwidth=2 softtabstop=2
autocmd BufRead,BufNewFile *.hbs set ft=html syntax=html
" Jinja
...
" sign customization
highlight GitGutterAdd    ctermbg=29   gui=bold guifg=Yellow
highlight GitGutterChange ctermbg=29   gui=bold guifg=Yellow 
highlight GitGutterDelete ctermbg=124  gui=bold guifg=Red
...
hi CocUnusedHighlight gui=underline guibg=16 cterm=underline   ctermbg=16
hi CocHintFloat       guifg=Yellow ctermfg=Yellow
hi CocFloatDividingLine guifg=Yellow ctermfg=DarkYellow
hi CocMarkdownLink      guifg=DarkYellow ctermfg=DarkYellow
hi CocPumSearch        guifg=Yellow  ctermfg=Yellow  
hi CocNotificationProgress guifg=Yellow ctermfg=Yellow
"hi CocWarningSign  guibg=Yellow  ctermbg=DarkYellow
"hi CocInfoSign      ctermbg=DarkYellow
hi CocErrorSign    guifg=Red ctermfg=Red
